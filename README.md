...
> 当前开发验收版本为 `v1.1.0`（`versionCode 10100`）；已在 OPPO 完成哔哩哔哩与小红书真实闭环。GitHub 最新公开正式版仍为 `v1.0.0`，`v1.1.0` 尚未上传发布。
...
android/app/build/outputs/formal-release/南枫下载-Android-v1.1.0.aab
```
...
当前仓库明确维护 Android 版，`v1.0.0` 是 GitHub 最新公开正式版；`v1.1.0` 已生成同证书 APK/AAB，并在 OPPO 完成两个新增平台的真实下载门槛，尚未上传 GitHub。Google Play 上架和签名密钥异地加密备份仍是后续独立任务。
